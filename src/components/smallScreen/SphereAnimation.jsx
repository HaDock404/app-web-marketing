        ...
        for (let i = 0; i < pathLength; i++) {
          animations.push(
            anime({
              ...
              stroke: {
                //value: ['rgba(255,255,255,1)', 'rgba(255, 62, 52,.35)'],
                //value: ['rgba(255,255,255,1)', 'rgba(255,122,0,1)'],
                value: ['rgba(255,255,255,1)', 'rgba(255,122,0,.35)'],
                duration: 500,
              },
              translateX: [2, -4],
              translateY: [2, -4],
        ...
        <svg className="sphere" viewBox="0 0 440 440" stroke="rgba(80,80,80,.35)">
          <defs>
            <linearGradient id="sphereGradient" x1="5%" x2="5%" y1="0%" y2="15%">
              ...
              <stop stopColor="#FF7A00" stopOpacity=".5" offset="200%" />
            </linearGradient>
          </defs>
